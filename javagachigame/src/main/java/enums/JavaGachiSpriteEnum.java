...
public enum JavaGachiSpriteEnum {
    ...
    BASE_SMOKE_0("Smoke 0", new File("/JavaGatchiBaseSpriteSmoke0.png")),
    BASE_SMOKE_1("Smoke 1", new File("/JavaGatchiBaseSpriteSmoke1.png")),
    BASE_SMOKE_2("Smoke 2", new File("/JavaGatchiBaseSpriteSmoke2.png"));
